...
class barang_second extends My_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('mdl_barang_second', 'barang_second');
	...
	function index()
	{
		...
		$config['total_rows'] = $this->barang_second->getallItem('barang');
		$config['per_page'] = '10';
		$config['num_links'] = '5';
		...
		$data['results'] = $this->barang_second->getItem($config['per_page'], $this->uri->segment(3));
		$this->load->view('barang_second/barang_second_list', $data);
