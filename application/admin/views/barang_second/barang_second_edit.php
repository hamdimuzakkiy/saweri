<script type="text/javascript">
	...
	function batal(){
		document.location.href = '<?=base_url().'index.php/barang_second'?>';
	}
...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('barang_second/process_update', $attributes);
		?>
			<h1>Master > Master Barang Second > Edit Data Barang Second</h1>
