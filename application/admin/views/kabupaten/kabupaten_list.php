		...
		<form class="block-content form" name="table_form" id="table_form" method="post" action="">
			...
			<div class="block-controls">
				...
				<ul class="controls-buttons">
					...
					<li><?
							if ($can_insert == TRUE){
								echo anchor('kabupaten/insert', 'Tambah Data');
							}
						?>
					</li>
				</ul>
			...
			<div class="no-margin"><table class="table" cellspacing="0" width="100%">
				...
				<tbody>
					...
					<tr>
						<!--<td align="left" valign="top"><input name="id[]" id="id" value="<?=$row->id_kabupaten?>" type="checkbox" /></td>-->
						<td align="center" valign="top"><?=$row->kabupaten?> </td>
		
						<td align="center" valign="top" class="table-actions">
							<?php
								if ($can_update == TRUE){
									echo anchor('kabupaten/update/'.$row->id_kabupaten, '<img src="'.base_url().'asset/admin/images/icons/fugue/pencil.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit')).'&nbsp;&nbsp;';
								}
								
								if ($can_delete == TRUE){
									 echo anchor('kabupaten/delete/'.$row->id_kabupaten, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
					</tr>
			...
			<div class="block-footer">
				...
				<span class="sep"></span>
				<?=anchor('kabupaten/insert', 'Tambah Data', array('class'=>'button'))?>
				<span class="sep"></span>
