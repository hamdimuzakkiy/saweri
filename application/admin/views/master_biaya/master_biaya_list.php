	...
	<div class="block-border">
		<form class="block-content form"  name="table_form" id="table_form" method="post" action="">
			...
			<div class="no-margin"><table class="table" cellspacing="0" width="100%">
				...
				<thead>
					<tr>
						<th align="left" valign="top" scope="col">Kode Biaya</th>
				...
				<tbody>
					...
					<tr>
						<td align="left" valign="top"><?=$row->id_biaya?> </td>
						<td align="left" valign="top"><?=$row->nama_biaya?> </td>						
						<td  align="left" valign="top" class="table-actions">
						<?php
								if ($can_update == TRUE){
									echo anchor('master_biaya/update/'.$row->id_biaya, '<img src="'.base_url().'asset/admin/images/icons/fugue/pencil.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit'));
								}
								
								if ($can_delete == TRUE){
									echo anchor('master_biaya/delete/'.$row->id_biaya, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
			...
			<div class="block-footer">
				...
				<span class="sep"></span>
				<?=anchor('master_biaya/insert', 'Tambah Data', array('class'=>'button'))?>
				<span class="sep"></span>
