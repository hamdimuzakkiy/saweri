		...
		<form class="block-content form" name="table_form" id="table_form" method="post" action="">
			...
			<div class="block-controls">
				...
				<ul class="controls-buttons">
					...
					<li><?
							if ($can_insert == TRUE){
								echo anchor('cabang/insert', 'Tambah Data');
							}
						?>
					</li>
				</ul>
			...
			<div class="no-margin"><table class="table" cellspacing="0" width="100%">
				...
				<thead>
					<tr>
						...
						<th align="left" valign="top" scope="col">Kode Cabang</th>
						...
						<th align="left" valign="top" scope="col">Max Piutang</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="left" valign="top"><?=$row->kode_cabang?> </td>
						<td align="left" valign="top"><?=$row->nama_cabang?> </td>
						<td align="left" valign="top"><?=$row->alamat?> </td>
						<td align="left" valign="top"><?=$row->telepon?> </td>
						<td align="left" valign="top"><?=$row->max_piutang?> </td>
						<td align="left" valign="top"><?=$row->saldo_piutang?> </td>
						<td align="left" valign="top" class="table-actions">
							<?php	
								if ($can_update == TRUE){
									echo anchor('cabang/update/'.$row->id_cabang, '<img src="'.base_url().'asset/admin/images/icons/fugue/pencil.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit')).'&nbsp;&nbsp;';
								}
								
								if ($can_delete == TRUE){
									echo anchor('cabang/delete/'.$row->id_cabang, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
					</tr>
			...
			<div class="block-footer">
				...
				<span class="sep"></span>
				<?php
						echo anchor('cabang/insert', 'Tambah Data', array('class'=>'button'));
				?>
				<span class="sep"></span>
