		...
		<form class="block-content form" name="table_form" id="table_form" method="post" action="">
			...
			<div class="block-controls">
				...
				<ul class="controls-buttons">
					...
					<li><?
							if ($can_insert == TRUE){
								echo anchor('kecamatan/insert', 'Tambah Data');
							}
						?>
					</li>
				</ul>
					...
					<tr>
						...
						<td align="center" valign="top" class="table-actions">
							<?php
								...
								if ($can_delete == TRUE){
									 echo anchor('kecamatan/delete/'.$row->id_kecamatan, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
					</tr>
