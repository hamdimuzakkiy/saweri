...
<script type="text/javascript">
	...
	$(document).ready(function() {
		//$("#getbarang").fancybox();
            ...
            $.ajax({
                url: site+"/laporan_pembelian/get_barang/",
            ...
            queryDelay: 200,
            innerText: "pencarian nama barang",
    ...
    function searchfunction(str) {
            $.ajax({
                url: site+"/laporan_pembelian/search_barang/"+str,
                success: function(response){			
                $('#jero_class').html(response);
                },
				dataType:"html"  		
...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('laporan_pembelian/view_lap_pembelian_barang', $attributes);
		?>
			<h1>Form Laporan Pembelian [Barang]</h1>
