		...
		<form class="block-content form" name="table_form" id="table_form" method="post" action="">
			<h1>Master > Master Member</h1>
				...
				<ul class="controls-buttons">
					...
					<li><?
							if ($can_insert == TRUE){
								echo anchor('member/insert', 'Tambah Data');
							}
						?></li>
				</ul>
				...
				<tbody>
					...
					<tr>
						...
						<td align="left" valign="top" class="table-actions">
							<?php
								if ($can_update == TRUE){
									echo anchor('member/update/'.$row->id_pelanggan, '<img src="'.base_url().'asset/admin/images/icons/fugue/pencil.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit'));
								}
								
								if ($can_delete == TRUE){
									 echo anchor('member/delete/'.$row->id_pelanggan, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
					</tr>
			...
			<div class="block-footer">
				...
				<span class="sep"></span>
				<?=anchor('member/insert', 'Tambah Data', array('class'=>'button'))?>			
				<span class="sep"></span>
