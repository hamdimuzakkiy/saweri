				...
				echo '
						<tr>
							...
							<td>
								...
								<input type="text" name="detail['.$i.'][harga]" value="'.$detail[$i]['harga'].'" />
								<input type="hidden" name="detail['.$i.'][total]" value="'.$detail[$i]['total'].'" />
							</td>
							<td>
								
								<input type="text" name="detail['.$i.'][harga_toko]" value="'.$detail[$i]['harga_toko'].'" />
							</td>
							<td>
								
								<input type="text" name="detail['.$i.'][harga_partai]" value="'.$detail[$i]['harga_partai'].'" />
							</td>
							<td>
								
								<input type="text" name="detail['.$i.'][harga_cabang]" value="'.$detail[$i]['harga_cabang'].'" />
							</td>
							<td>
			...
			echo '
						<tr>
							...
							<td>
								...
								<input type="text" name="detail['.$i.'][harga]" value="'.$data['detail_harga'].'" />
								<input type="hidden" name="detail['.$i.'][total]" value="'.$data['detail_total'].'" />
							</td>
							<td>
								
								<input type="text" name="detail['.$i.'][harga_toko]" value="'.$data['detail_harga_toko'].'" />
							</td>
							<td>
								
								<input type="text" name="detail['.$i.'][harga_partai]" value="'.$data['detail_harga_partai'].'" />
							</td>
							<td>
								
								<input type="text" name="detail['.$i.'][harga_cabang]" value="'.$data['detail_harga_cabang'].'" />
							</td>
							<td>
